...
WRKSPC  .EQU    RAMTOP + 0x100;0x8045               ; BASIC Work space
USR     .EQU    WRKSPC+0x03          ; "USR (x)" jump
OUTSUB  .EQU    WRKSPC+0x06          ; "OUT p,n"
OTPORT  .EQU    WRKSPC+0x07          ; Port (p)
DIVSUP  .EQU    WRKSPC+0x09          ; Division support routine
...
CURPOS  .EQU    WRKSPC+0xAB          ; Character position on line
LCRFLG  .EQU    WRKSPC+0xAC          ; Locate/Create flag
TYPE    .EQU    WRKSPC+0xAD          ; Data type flag
DATFLG  .EQU    WRKSPC+0xAE          ; Literal statement flag
LSTRAM  .EQU    WRKSPC+0xAF          ; Last available RAM
TMSTPT  .EQU    WRKSPC+0xB1          ; Temporary string pointer
TMSTPL  .EQU    WRKSPC+0xB3          ; Temporary string pool
TMPSTR  .EQU    WRKSPC+0xBF          ; Temporary string
STRBOT  .EQU    WRKSPC+0xC3          ; Bottom of string space
CUROPR  .EQU    WRKSPC+0xC5          ; Current operator in EVAL
LOOPST  .EQU    WRKSPC+0xC7          ; First statement of loop
DATLIN  .EQU    WRKSPC+0xC9          ; Line of current DATA item
FORFLG  .EQU    WRKSPC+0xCB          ; "FOR" loop flag
LSTBIN  .EQU    WRKSPC+0xCC          ; Last byte entered
READFG  .EQU    WRKSPC+0xCD          ; Read/Input flag
BRKLIN  .EQU    WRKSPC+0xCE          ; Line of break
NXTOPR  .EQU    WRKSPC+0xD0          ; Next operator in EVAL
ERRLIN  .EQU    WRKSPC+0xD2          ; Line of error
CONTAD  .EQU    WRKSPC+0xD4          ; Where to CONTinue
PROGND  .EQU    WRKSPC+0xD6          ; End of program
VAREND  .EQU    WRKSPC+0xD8          ; End of variables
ARREND  .EQU    WRKSPC+0xDA          ; End of arrays
NXTDAT  .EQU    WRKSPC+0xDC          ; Next data item
FNRGNM  .EQU    WRKSPC+0xDE          ; Name of FN argument
FNARG   .EQU    WRKSPC+0xE0          ; FN argument value
FPREG   .EQU    WRKSPC+0xE4          ; Floating point register
FPEXP   .EQU    FPREG+3              ; Floating point exponent
SGNRES  .EQU    WRKSPC+0xE8          ; Sign of result
PBUFF   .EQU    WRKSPC+0xE9          ; Number print buffer
MULVAL  .EQU    WRKSPC+0xF6          ; Multiplier
PROGST  .EQU    WRKSPC+0xF9          ; Start of program text area
...
ZDATA   .EQU    0x83            ; DATA
ZGOTO   .EQU    0x88            ; GOTO
ZGOSUB  .EQU    0x8C            ; GOSUB
ZREM    .EQU    0x8E            ; REM
ZPRINT  .EQU    0x9E            ; PRINT
ZNEW    .EQU    0xA4            ; NEW
...
ZLTH    .EQU    0xB5            ; <
ZSGN    .EQU    0xB6            ; SGN
ZPOINT  .EQU    0xC7            ; POINT
ZLEFT   .EQU    0xCD +2         ; LEFT$
...
DATA:   .BYTE   0x01,0x3A       ; ':' End of statement
...
GETHEX: INC     DE              ; Next location
        ...
        CP      #0x0A           ; Value should be $0A-$0F at this point
        RET     C               ; CY set if was :            ; < = > ? @
