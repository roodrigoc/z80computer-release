...
shl_reg:
    ...
    push ix
    ld ix,0FFF8h    ; Allocates 8 bytes
    add ix,sp
    ld sp,ix
...
mul_reg2_by_reg1:
    ...
    push ix
    ld ix,0FFF8h-2*NBYTES    ; Allocates 8 bytes + 2 buffers
    add ix,sp
    ld sp,ix
...
mul_reg2_by_reg1_end:
    ...
    ld hl,0008h+2*NBYTES    ; Frees 8 bytes + 2 buffers
    add hl,sp
    ld sp,hl
    pop ix
    ret
...
mul_reg_10:
    ...
    push ix
    ld ix,0FFF8h-NBYTES    ; Allocates 8 bytes + buffer
    add ix,sp
    ld sp,ix
...
;    add_reg2_to_reg1(reg,regmdiv);
    ...
    ld hl,0008h+NBYTES    ; Frees 8 bytes + buffer
    add hl,sp
    ld sp,hl
    pop ix
    ret
...
div_reg2_by_reg1:
    ...
    push ix
    ld ix,0FFF6h-3*NBYTES    ; Allocates 10 bytes + 3 buffers
    add ix,sp
    ld sp,ix
...
div_reg2_by_reg1_end:
    ...
    ld hl,000Ah+3*NBYTES    ; Frees 10 bytes + 3 buffers
    add hl,sp
    ld sp,hl
    pop ix
    or a
